...
export function useTracker<T>(autorun: () => T, deps: React.DependencyList, initial?: T): T | undefined {
	const [meteorData, setMeteorData] = useState(initial)
...
/**
 * A Meteor Session hook that works like useState, except that values are retained when reloading the page.
 * This is useful for UI-related stuff
 * @param key
 * @param initial
 * @returns
 */
export function useSession<T>(key: string, initial: T): [T, (newValue: T) => void] {
